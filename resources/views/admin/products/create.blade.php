@extends('layout')
@section('content')
    <form action="{{ route('products.store') }}" method="POST" enctype="multipart/form-data" class="bg-white shadow p-4 py-8" x-data="{ images: [] }">
        @csrf
        <div class="heading text-center font-bold text-2xl m-5 text-gray-800 bg-white">New Product</div>
        @if(session('success'))
        ...
        <div class="editor mx-auto w-10/12 flex flex-col text-gray-800 border border-gray-300 p-4 shadow-lg max-w-2xl">
            <input class="title bg-gray-100 border border-gray-300 p-2 mb-4 outline-none" spellcheck="false" name="name" placeholder="Title" type="text" required>
            ...
            <textarea class="description bg-gray-100 sec p-3 h-40 my-4 mb-4 border border-gray-300 outline-none" spellcheck="false" name="short_description" required placeholder="Describe short description about this product here"></textarea>
            <textarea class="description bg-gray-100 sec p-3 h-60 border border-gray-300 outline-none" spellcheck="false" name="full_description" required placeholder="Describe full description about this product here"></textarea>
