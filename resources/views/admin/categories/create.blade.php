@extends('layout')
@section('content')
    <form action="{{route('categories.store')}}" method="POST" enctype="multipart/form-data" class="bg-white shadow p-4 py-8" x-data="{ images: [] }">
        @csrf
        <div class="heading text-center font-bold text-2xl m-5 text-gray-800 bg-white">New Category</div>
        @if(session('success'))
        ...
        <div class="editor mx-auto w-10/12 flex flex-col text-gray-800 border border-gray-300 p-4 shadow-lg max-w-2xl">
            ...
            <textarea class="description bg-gray-100 sec p-3 h-40 mb-4 border border-gray-300 outline-none" spellcheck="false" name="short_description" required placeholder="Describe short description about this category here"></textarea>
            <textarea class="description bg-gray-100 sec p-3 h-60 border border-gray-300 outline-none" spellcheck="false" name="full_description" required placeholder="Describe full description about this category here"></textarea>
